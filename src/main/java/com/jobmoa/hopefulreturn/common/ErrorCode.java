...
public enum ErrorCode {
    ...
    QR_VERIFICATION_FAILED(HttpStatus.BAD_REQUEST, "본인 확인에 실패했습니다. 성명과 전화번호를 확인해주세요."),
    QR_NOT_CLASS_DAY(HttpStatus.BAD_REQUEST, "오늘은 교육일이 아닙니다."),
    QR_ALREADY_CHECKED_IN(HttpStatus.BAD_REQUEST, "이미 입실 처리되었습니다."),
    QR_NOT_CHECKED_IN(HttpStatus.BAD_REQUEST, "입실 기록이 없습니다."),
    QR_ALREADY_CHECKED_OUT(HttpStatus.BAD_REQUEST, "이미 퇴실 처리되었습니다."),

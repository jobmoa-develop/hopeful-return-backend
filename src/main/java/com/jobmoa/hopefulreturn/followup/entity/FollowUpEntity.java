...
public class FollowUpEntity {
    ...
    @Column(name = "forest_program_date")
    private LocalDate forestProgramDate;

    @Column(name = "national_program_date")
    private LocalDate nationalProgramDate;

    @Column(name = "national_program_branch", length = 30)
    private String nationalProgramBranch;
